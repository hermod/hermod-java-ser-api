...
public enum EType {
    ...
    NULL(Types.NULL_TYPE), MSG(Types.MSG_TYPE), INTEGER(Types.INTEGER_TYPE), DECIMAL(Types.DECIMAL_TYPE), STRING_ISO_8859_1(Types.STRING_ISO_8859_1_TYPE), STRING_UTF16(Types.STRING_UTF16_TYPE), ARRAY_FIXED_VALUE(
